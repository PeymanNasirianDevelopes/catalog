            ...
            <div class="hero-wrapper">
                ...
                <div class="main-navigation">
                    <div class="container">
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item has-child">
                                        ...
                                        <ul class="child">
                                            ...
                                            <li class="nav-item">
                                                <a href="" class="nav-link">Submit Ad</a>
                                            </li>
                                            <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="" class="btn btn-primary text-caps btn-rounded btn-framed">Submit Ad</a>
                                    </li>
                                </ul>
                                <!--Main navigation list-->
                            </div>
                        ...
                        <!--end navbar-->
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="http://themestarz.net/html/craigs/index.html">Home</a></li>
                    ...
                    <section>
                        <div class="alert alert-warning" role="alert">
                            ...
                            <p>You can submit only 1 ad at a time. To submit more, you need to
                                <a href="http://themestarz.net/html/craigs/sign-in.html" class="link"><strong>Sign In</strong></a> or
                                <a href="http://themestarz.net/html/craigs/register.html" class="link"><strong>Register</strong></a></p>
                        </div>
                    </section>
                                    ...
                                    <div class="form-slides" id="category-tabs">
                                        ...
                                        <div class="form-slide" id="computers">
                                            ...
                                            <figure class="category-icon">
                                                <img src="index_files/computer.png" alt="">
                                            </figure>
                                            <!--end category-icon-->
                                            <div class="row">
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-slide" id="real_estate">
                                            <h3>Real Estate</h3>
                                            <figure class="category-icon">
                                                <img src="index_files/real-est.png" alt="">
                                            </figure>
                                            <!--end category-icon-->
                                            <div class="row">
                                                <div class="col-md-6">
                                        ...
                                        <div class="form-slide" id="cars_motorcycles">
                                            ...
                                            <figure class="category-icon">
                                                <img src="index_files/car00000.png" alt="">
                                            </figure>
                                            <!--end category-icon-->
                                            <div class="row">
                                                <div class="col-md-6">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="accordion-heading-1">
                                        <h4 class="panel-title">
                                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="" aria-expanded="false" aria-controls="accordion-collapse-1">
...
<!-- This document saved from http://themestarz.net/html/craigs/submit.html -->
