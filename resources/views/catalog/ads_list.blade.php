                ...
                <div class="main-navigation">
                    <div class="container">
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                                        ...
                                        <ul class="child">
                                            ...
                                            <li class="nav-item has-child">
                                                ...
                                                <ul class="child">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="" class="nav-link">My Ads</a>
                                                    </li>
                                                    <li class="nav-item">
                            ...
                            <!--end navbar-collapse-->
                            <a href="" class="main-search-form-toggle" data-toggle="collapse"  aria-expanded="false" aria-controls="collapseMainSearchForm">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <nav class="nav flex-column side-nav">
                                <a class="nav-link icon" href="http://themestarz.net/html/craigs/my-profile.html">
                                    <i class="fa fa-user"></i>My Profile
                                </a>
                                <a class="nav-link active icon" href="">
                                    <i class="fa fa-heart"></i>My Ads Listing
                                </a>
                                <a class="nav-link icon" href="http://themestarz.net/html/craigs/bookmarks.html">
                                    <i class="fa fa-star"></i>Bookmarks
                                </a>
                                <a class="nav-link icon" href="http://themestarz.net/html/craigs/change-password.html">
                                    <i class="fa fa-recycle"></i>Change Password
                                </a>
                                <a class="nav-link icon" href="http://themestarz.net/html/craigs/sold-items.html">
                                ...
                                <div class="item">
                                    ...
                                    <div class="wrapper">
                                        ...
                                        <div class="admin-controls">
                                            <a href="http://themestarz.net/html/craigs/edit-ad.html">
...
<!-- This document saved from http://themestarz.net/html/craigs/my-ads.html -->
